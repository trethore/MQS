...
- The codebase targets Fabric for Minecraft 1.21.11 with Yarn mappings `1.21.11+build.4`; use APIs that exist in this combination.
...
- Fabric Loader, Fabric API, and Yarn mappings are versioned in `gradle.properties`; Fabric Loom integrates them into the client source set and remaps game classes during packaging. Keep these aligned with Minecraft `1.21.11` before updating APIs.
