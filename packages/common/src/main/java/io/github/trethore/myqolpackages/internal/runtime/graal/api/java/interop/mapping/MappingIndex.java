...
public final class MappingIndex {
    ...
    private MappingIndex(Map<String, ClassMapping> classMappings) {
        ...
        for (ClassMapping classMapping : classMappings.values()) {
            ...
            if (existingNamedClassName != null && !existingNamedClassName.equals(classMapping.namedClassName())) {
    ...
    public static final class Builder {
        ...
        public void addMethod(
                String namedClassName, String namedMethodName, String runtimeMethodName, List<String> parameterTypes) {
            MutableClassMapping classMapping = requireClassMapping(namedClassName);
            List<MethodMapping> methodMappings =
                    classMapping.methodMappings.computeIfAbsent(namedMethodName, ignored -> new ArrayList<>());
        ...
        public void addField(String namedClassName, String namedFieldName, String runtimeFieldName) {
            MutableClassMapping classMapping = requireClassMapping(namedClassName);
            String existingName = classMapping.fieldMappings.putIfAbsent(namedFieldName, runtimeFieldName);
        ...
        public MappingIndex build() {
            ...
            classMappings.forEach((namedClassName, mapping) -> mappings.put(
                    namedClassName,
                    new ClassMapping(
                            namedClassName, mapping.runtimeClassName, mapping.methodMappings, mapping.fieldMappings)));
