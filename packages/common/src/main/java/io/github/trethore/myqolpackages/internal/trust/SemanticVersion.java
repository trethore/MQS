...
public record SemanticVersion(int major, int minor, int patch, List<String> prerelease, List<String> build)
    ...
    public static SemanticVersion parse(String value) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Semantic version number is too large: " + value, exception);
        }
    }
    ...
    public int compareTo(@NotNull SemanticVersion other) {
        ...
        for (int index = 0; index < sharedIdentifiers; index++) {
            int identifierComparison = comparePrereleaseIdentifier(prerelease.get(index), other.prerelease.get(index));
    ...
    private static void validateIdentifiers(List<String> identifiers, boolean prereleaseIdentifiers) {
        for (String identifier : identifiers) {
            ...
            if (prereleaseIdentifiers
                ...
                throw new IllegalArgumentException("Numeric prerelease identifiers must not contain leading zeroes");
            }
        }
    }
