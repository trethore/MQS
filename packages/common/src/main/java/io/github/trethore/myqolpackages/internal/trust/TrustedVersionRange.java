        ...
        switch (operator) {
          ...
          default ->
              throw new IllegalArgumentException(
                  "Unsupported trusted version range: " + expression);
        };
  ...
  private static SemanticVersion compatibleUpperBound(SemanticVersion version) {
    if (version.major() > 0) {
      return new SemanticVersion(
          version.major() + 1, 0, 0, java.util.List.of(), java.util.List.of());
    }
    if (version.minor() > 0) {
      return new SemanticVersion(
          0, version.minor() + 1, 0, java.util.List.of(), java.util.List.of());
    }
