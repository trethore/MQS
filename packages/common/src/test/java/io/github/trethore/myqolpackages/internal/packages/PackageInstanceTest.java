...
class PackageInstanceTest {
    ...
    private PackageInstance createInstance(PackageContextFactory contextFactory, Path packageRoot) {
        ...
        PackageManifest manifest =
                new PackageManifest("example-package", "Example Package", "A test package.", "1.0.0", "src/index.js");
        PackageDescriptor descriptor = new PackageDescriptor(
                "example-package", packageDirectory, packageDirectory.resolve("src/index.js"), manifest);
