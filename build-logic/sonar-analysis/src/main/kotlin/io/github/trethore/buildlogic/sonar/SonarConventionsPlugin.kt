...
class SonarConventionsPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        project.tasks.register(SonarConstants.DUPLICATE_TASK_NAME) {
            group = SonarConstants.TASK_GROUP
            description = "Deprecated alias for ${SonarConstants.DUPLICATES_TASK_NAME}."
            dependsOn(SonarConstants.DUPLICATES_TASK_NAME)
        }
