        ...
        val client = FakeSonarClient { request ->
            when (request.parameters["p"]) {
                ...
                "2" -> mapOf(
                    ...
                    "issues" to listOf(
                        mapOf(
                            "component" to "mqp:src/Bar.java",
                            "rule" to "java:S2",
                            "message" to "Second issue",
                            "impacts" to listOf(
                                mapOf("severity" to "HIGH", "softwareQuality" to "MAINTAINABILITY")
                            ),
                        )
                    ),
                )
