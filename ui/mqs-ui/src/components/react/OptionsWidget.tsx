...
export function OptionsWidget() {
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      <div className="pointer-events-none absolute right-0 bottom-0 left-0 flex justify-end p-4 pb-0">
        <Button
          type="button"
          size="icon"
          variant="default"
          className={
            "mqs-surface-shadow mqs-surface-shadow-front size-12 pointer-events-auto shadow-[0_1rem_2.5rem_-0.75rem_rgb(0_0_0_/_0.55)] transition-all duration-200 ease-out disabled:pointer-events-auto disabled:cursor-not-allowed " +
            (dirty
              ? "translate-y-0 scale-100 opacity-100"
              : "pointer-events-none translate-y-3 scale-90 opacity-0")
          }
          disabled={saving || openingPath || !dirty}
